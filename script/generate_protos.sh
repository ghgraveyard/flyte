...
cp -r gen/pb-go/github.com/flyteorg/flyte/gen/* gen/
rm -rf gen/pb-go/github.com

# Copy the validate.py protos.
mkdir -p gen/pb_python/validate
cp -r protos/validate/* gen/pb_python/validate/

# Update the service code manually because the code generated by protoc is incorrect
# More detail, check https://github.com/flyteorg/flyte/pull/303#discussion_r1002151053
